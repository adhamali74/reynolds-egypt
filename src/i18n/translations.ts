...
export const TRANSLATIONS: Record<Lang, Dict> = {
  en: {
    ...
    "careers.form.step1": "Submit your application & CV",
    "careers.form.step2": "Our team reviews it personally",
    "careers.form.step3": "We reach out within 3 business days",
  ...
  ar: {
    ...
    "careers.form.step1": "أرسِل طلبك وسيرتك الذاتية",
    "careers.form.step2": "يراجع فريقنا طلبك شخصياً",
    "careers.form.step3": "نتواصل معك خلال 3 أيام عمل",
