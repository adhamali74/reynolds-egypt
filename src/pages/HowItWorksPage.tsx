    ...
    <main className="relative pt-20">
      ...
      <section className="relative bg-ink-950 py-20">
        <div className="mx-auto flex max-w-5xl flex-col items-center gap-5 px-6 text-center sm:px-10">
          ...
          <Link
            to="/contact"
            className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-magenta-500 to-royal-500 px-7 py-3.5 text-sm font-medium text-white shadow-[0_20px_60px_-10px_rgba(230,1,122,0.5)]"
          >
            {t("how.cta.button")} <ArrowRight size={16} />
          </Link>
        </div>
      </section>
      <SectionDivider />
